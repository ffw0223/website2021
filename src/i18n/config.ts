export const resources = {
  en: {
    translation: {
      ...
      "Please comment，press the like the button, share, retweet, and subscribe to our social platforms.": "Please comment，press the like the button, share, retweet, and subscribe to our social platforms.",
  ...
  cn: {
    translation: {
      ...
      "Please comment，press the like the button, share, retweet, and subscribe to our social platforms.": "请评论，点赞，分享，转发，和订阅我们的社交帐户。",
      "Team members": "团队成员",
      ...
      "The aggregator obtains external request data through Scanner, sends the request to the Provider to process all Oracle requests, uses VRF to ensure the randomness of the aggregator.": "聚合者通过Scanner获取外界的请求数据，将请求发送到Provider处理所有的Oracle请求，运用VRF保证聚合者的随机性。",
      "Aggregator": "聚合者",
      "Uniswap": "Uniswap",
